...
class AutomatedTrader:
    ...
    def __init__(self, max_positions: int = 15, max_investment_per_stock: float = 5000):
        ...
        print(f"[OK] Expanded watchlist: {len(self.watchlist)} symbols")
    ...
    def start_automated_trading(self):
        ...
        self.running = True
        print(f"\n[RELOAD] RELOADING PORTFOLIO FROM DATABASE...")
        ...
        if reloaded > 0:
            ...
            print(f"   [OK] Reloaded {reloaded} positions, updated {updated} with current prices")
