    ...
    def get_stock_data(self, symbol: str, period: str = "6mo") -> Dict:
        ...
        try:
            ...
            if is_crypto:
                ...
                # yfinance para cryptos principales que soporta
                yfinance_cryptos = ["BTC-USD", "ETH-USD", "SOL-USD", "BNB-USD", "ADA-USD", "XRP-USD", "DOT-USD", "DOGE-USD", "LTC-USD", "BCH-USD", "LINK-USD", "MATIC-USD", "AVAX-USD"]
                if symbol.upper() in yfinance_cryptos:
                    df = crypto_collector.get_yfinance_data(symbol, period="90d", interval="1d")
                else:
                    # CoinGecko para cryptos no soportadas por yfinance
                    coingecko_map = {
                        "BNB-USD": "binancecoin", "BNB-EUR": "binancecoin",
                        "UNI-USD": "uniswap", "AAVE-USD": "aave",
                        "ATOM-USD": "cosmos", "ALGO-USD": "algorand",
                        "FTM-USD": "fantom", "ONE-USD": "harmony",
                        "NEAR-USD": "near", "FLOW-USD": "flow",
                        "SHIB-USD": "shiba-inu", "ETC-USD": "ethereum-classic"
                    }
